// // тут будет характеристика, в которую можно записывать новое устройство
// #include <EEPROM.h>
// #include "Wire.h"
// #include <BLEDevice.h>
// #include <BLEUtils.h>
...
// 	// Двоичная to двоично-десятичная
...
// 	void init() {
// 		// INITIAL DATE
// 		prl("Init time: 23.26.30 Cp 26 дек 2019");
// 		Wire.begin();
...
// 			timeNum++;
// 		}
// 		// Если были НЕ все 7 дней недели, оставить знак остановки
// 		if (timesLength < 7) {
...
// 		EEPROM.commit();  // Чтобы всё сразу за раз
// 	}
...
// 	void checkBattery() {
// 		int charge = Battery::getCharge(); // в %-ах
...
// 			if (rxValue.length() > 0) {
// 				pr("Received value: ");  //  "Полученное значение: "
